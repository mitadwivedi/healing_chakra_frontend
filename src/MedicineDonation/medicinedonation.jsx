...
class MedicineDonation extends React.Component {
    state = {
        username: "",
        medicinename: "",
        manufacturedate: "",
    ...
    async medicineRequest(params) {
        // let data = await axios_post_request("http://192.168.123.100:3001/healing-chakra/login_request/", params)
        let data = await axios_post_request("http://127.0.0.1:8000/healing-chakra/submit-medicine-donation/", params)
    ...
    mySubmitHandler = (event) => {
        ...
        this.medicineRequest(params).then(r => {
    ...
    setExpiryDate = (date, dateString, id) => {
                    ...
                    <div style={{marginTop: 16, width: "30%"}} align={"center"}>
                        <form onSubmit={this.mySubmitHandler}>
                            <div style={{textAlign: "center"}}>
                                <p style={{fontSize: '20px', textAlign: 'left', fontFamily: 'Times New Roman'}}><b>Donate Your Medicine</b></p><br/>
                            </div>
                            <div className="item">
                                <div className="item">
                                    <input type='text' name="medicinename" placeholder="Medicine Name"
                                           onChange={this.setMedicineName}/>
                                </div>
                            </div>
                            <div className="item">
                                <div className="item">
                            ...
                            <div className="item">
                                <div className="item">
                                    <DatePicker placeholder={'Expiry Date'} format={'MM-DD-YYYY'} style={{ width: '98%' }}
                                                name="expirydate" onChange={(date, dateString) => this.setExpiryDate(date, dateString, 1)}/>
                                </div>
                            </div>
                            <div className="item">
                                <div className="item">
